...
QGIS est un logiciel libre et gratuit de système d'information géographique (SIG). Pour cet atelier, nous utiliserons **QGIS version 3.40 Bratislava LTR'** (version à long terme).

## Téléchargement

### Windows
1. Téléchargez [Online (OSGeo4W) installer](https://download.osgeo.org/osgeo4w/v2/osgeo4w-setup.exe)
